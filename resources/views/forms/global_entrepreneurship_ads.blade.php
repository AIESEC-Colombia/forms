...
@section('content')
    <div class="container-fluid bg-entrepreneur">
        <div class="row d-flex justify-content-center">
            <div class="col-sm-12 col-md-10">
                <div class="form-step" id="form-step">
                    <h2 class="header" id="title" style="color: #fff">@lang('forms.entrepreneurship')</h2>
                    <p style="color: #fff">@lang('forms.entrepreneurship_message')</p>
                    <fieldset class="step" data-step="0">
                        ...
                        <div class="form-group d-flex justify-content-between">
                            ...
                            <button class="btn btn-primary btn-sm next btn-entrepreneur" data-next="1">Siguiente
                            </button>
                        </div>
                    </fieldset>
                    <fieldset class="step" data-step="1">
                        ...
                        <div class="form-group d-flex justify-content-between">
                            ...
                            <button class="btn btn-primary btn-sm btn-entrepreneur" id="submit">Enviar</button>
                        </div>
                    </fieldset>
                </div>
            </div>
