...
class CreateFormsRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'password' => 'sometimes|required|regex:/^(?=.*\d)(?=.*[a-zA-Z]).{8,16}$/',
            'password_confirmation' => 'sometimes|confirmed',
    ...
    public function messages()
    {
        return [
            ...
            'mail.mail' => 'Ingrese un ' . __('forms.mail') . ' valido.',
            ...
            'password_confirmation.confirmed' => 'La ' . __(' forms.password_confirmation') . ' no coincide.',
            'organization.required' => 'La ' . __('forms.organization') . ' es requerida.',
            'activities.required' => 'La ' . __('forms.activities') . ' es requerida.',
            ...
            'career.required' => 'La ' . __('forms.career') . ' es requerida.',
            'semester.required' => 'EL ' . __('forms.semester') . ' es requerido.',
            'terms.required' => 'Los ' . __('forms.terms') . ' son requeridos',
        ];
